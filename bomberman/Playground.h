...
public:
	...
	/**
	 * Iterates over objects in the current round.
	 ...
	 */
	static Predicate Overlapping(Square const &position);

	/**
	 * Calls given visitor for all objects satisfying given predicate.
	 */
