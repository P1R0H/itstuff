...
inline bool containsBomb(Playground const &playground, Square const &position) {
...
inline bool containsFlame(Playground const &playground, Square const &position) {
	struct Visitor final : ConstObjectVisitorSkeleton {
		bool ret = false;
...
inline bool containsBonusItem(Playground const &playground, Square const &position) {
	struct Visitor final : ConstObjectVisitorSkeleton {
		bool ret = false;
...
inline bool containsWall(Playground const &playground, Square const &position) {
	struct Visitor final : ConstObjectVisitorSkeleton {
		bool ret = false;
